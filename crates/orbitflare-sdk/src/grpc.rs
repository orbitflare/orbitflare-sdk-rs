...
use orbitflare_sdk_proto::geyser::{
    geyser_client::GeyserClient as ProtoGeyserClient, SubscribeRequest, SubscribeRequestPing,
...
impl Default for GeyserClientBuilder {
    fn default() -> Self {
        Self::new()
    }
}
...
impl GeyserClientBuilder {
    ...
    pub fn build(self) -> Result<GeyserClient> {
        ...
        Ok(GeyserClient {
            inner: Arc::new(GeyserClientInner {
                endpoints,
                retry: self.retry,
